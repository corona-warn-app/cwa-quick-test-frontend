...
const Statistics = (props: any) => {
  ...
  const [statisticData, thisWeekStatisticData, thisMonthStatisticData] = useStatistics(
    undefined,
    handleError
  );
  ...
  React.useEffect(() => {
    if (
      ...
      setStatisticRows([
        ...
        {
          ...thisWeekStatisticData,
          label: t('translation:thisWeek'),
          key: Math.random(),
        },
        {
          ...thisMonthStatisticData,
          label: t('translation:thisMonth'),
          key: Math.random(),
        },
      ]);
      setIsInit(true);
  ...
  return !(
    ...
    */}
        <Card.Body id='data-header'>
          ...
          <hr />
          <StatisticDataRow
            statisticData={statisticRows}
            pcrEnabled={pcrEnabled}
            deleteRow={handleDeleteStatisticRow}
          />
        </Card.Body>
