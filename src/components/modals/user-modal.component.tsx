  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Modal.Title>
            {isNew ? t('translation:add-user') : t('translation:edit-user')}
          </Modal.Title>
        </Modal.Header>

        <Modal.Body className='bg-light'>
          <FormGroupInput
            controlId='formUserNameInput'
          ...
          <FormGroupPermissionCkb
            controlId='formRoleLab'
            title={t('translation:permission')}
            label={t('translation:for-lab')}
