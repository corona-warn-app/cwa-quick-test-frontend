    ...
    <>
      ...
      >
        ...
        <Modal.Body className='px-3 bg-light'>
          <h5 className='text-justify'>T-Systems International GmbH</h5>
          ...
          <Container className='px-1 px-sm-2 px-md-3'>
            ...
            <p>
              ...
              <br />
              E-Mail: <a href='mailto:info@t-systems.com'>info@t-systems.com</a>
              <br />
              Telefon: 069 20060 - 0
            </p>
            ...
            <p>
              ...
              <br />
              Amtsgericht Frankfurt am Main, HRB 55933, Sitz der Gesellschaft: Frankfurt am Main,
              Deutschland
              <br />
            ...
            <p>
              <a
                href='https://www.t-systems.com/de/de/kontakt#_blank'
                rel='noreferrer'
                target='_blank'
              >
                Kontakt aufnehmen
